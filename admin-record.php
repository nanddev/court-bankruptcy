  ...
  <form name="admin_recordform" id="admin_recordform" method="post" action="">
    <table width="100%" border="0" cellspacing="2" cellpadding="2" >
      <tr  style="color:#000;" align="center">
        ...
        <td width="32%" ><a href="upload_citation_record.php">Upload Data File &nbsp;</a></td>
        <td ></td>
      ...
      <tr>
        <td colspan="2" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input name="account_cid" type="text" id="account_cid" /></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
        ...
        <td><table width="100%" border="0" cellspacing="3" cellpadding="3">
            <tr>
              ...
              <td><input name="municipality" type="text" id="municipality" /></td>
            </tr>
            <tr>
              <td>Clerk of Court#1</td>
              <td><input name="clerk_of_court1" type="text" id="clerk_of_court1" /></td>
            </tr>
            <tr>
              <td>Clerk of Court#2</td>
              <td><input name="clerk_of_court2" type="text" id="clerk_of_court2" /></td>
            </tr>
            <tr>
              <td>Clerk of Court#3</td>
              <td><input name="clerk_of_court3" type="text" id="clerk_of_court3" /></td>
            </tr>
            <tr>
              <td>Client Name</td>
            ...
            <tr>
              <td>Web Address</td>
              <td><input name="webaddress" type="text" id="webaddress" />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Judge Name</td>
              <td><input name="judge_name" type="text" id="judge_name" /></td>
            </tr>
            <tr>
              <td>Judge Phone</td>
              <td><input name="judge_phone" type="text" id="judge_phone" /></td>
            </tr>
            <tr>
              <td>Judge Email</td>
              <td><input name="judge_email" type="text" id="judge_email" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td><input name="police_contact" type="text" id="police_contact" /></td>
            </tr>
            <tr>
              <td>Police Phone</td>
              <td><input name="police_phone" type="text" id="police_phone" /></td>
            </tr>
            <tr>
              <td>Police Email</td>
              <td><input name="police_email" type="text" id="police_email" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td><input name="sheriff_contact" type="text" id="sheriff_contact" /></td>
            </tr>
            <tr>
              <td>Sheriff Phone</td>
              <td><input name="sheriff_phone" type="text" id="sheriff_phone" /></td>
            </tr>
            <tr>
              <td>Sheriff Email</td>
              <td><input name="sheriff_email" type="text" id="sheriff_email" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td><input name="routing_number" type="text" id="routing_number" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input name="ticket_volume" type="text" id="ticket_volume" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td colspan="2" align="center"><input name="Admin_Register" type="submit" value="Save" onclick="return validate_admin_record();" /></td>
            </tr>
        </table></td>
        <td>&nbsp;</td>
      </tr>
...
<p>&nbsp;</p>
<div align="center" style="padding-top:1260px; padding-bottom:30px;">All rights reserved. 2012 <a href="disclaimer.php">Disclaimer </a></div>
</div>
