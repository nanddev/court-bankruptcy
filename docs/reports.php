...
if(document.Reports_form1.monthfrom.value=="")
{
alert("Please select order Period Month From");
document.Reports_form1.monthfrom.focus();
return false;
}
if(document.Reports_form1.datefrom.value=="")
{
alert("Please select order Period Date From");
document.Reports_form1.datefrom.focus();
return false;
}
if(document.Reports_form1.yearfrom.value=="")
{
alert("Please select order Period Year From");
document.Reports_form1.yearfrom.focus();
return false;
}

if(document.Reports_form1.monthto.value=="")
{
alert("Please select order Period Month To");
document.Reports_form1.monthto.focus();
return false;
}

if(document.Reports_form1.dateto.value=="")
{
alert("Please select order Period Date To");
document.Reports_form1.dateto.focus();
return false;
}

if(document.Reports_form1.yearto.value=="")
{
alert("Please select order Period Year To");
document.Reports_form1.yearto.focus();
return false;
}
...
<div style="float:left; width:80%;padding:15px ">
<table width="90%" border="0" cellspacing="3" cellpadding="3">
  <tr>
    <td width="26%"><strong>Reports</strong></td>
    <td width="74%"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="21%"><strong>Account CID </strong></td>
      <td width="29%"><select name="account_cid">
	  
	  <option value="AR002">AR002</option>
	   <option value="AR003">AR003</option>
	  <option value="AR001">AR001</option>
	  <option value="AR004">AR004</option>
	  <option value="AR005">AR005</option>
	  <option value="AR006">AR006</option>
  ...
  <tr>
    <td><strong>Select Date Range</strong></td>
 ...
 */
// 2012-06-01 00:00:00
  $date_from = $_REQUEST['yearfrom']."-".$_REQUEST['monthfrom']."-".$_REQUEST['datefrom']." 00:00:00";
//  "<br>";
  $date_to = $_REQUEST['yearto']."-".$_REQUEST['dateto']."-".$_REQUEST['monthto']." 00:00:00";
...
?>
<p style="padding-left:20px; "><span class="head_disclaimer"><a href="#">Combined</a></span> | <span class="head_disclaimer"><a href="#">Bankruptcy</a></span> | <a href="#"><span class="head_disclaimer">Citations</span></a></p>
</div>
<div style="clear:both"></div>
<p>&nbsp;</p>
