...
-->
<?php
$select_admin=mysql_query("select * from partner order by id desc" )or die(mysql_error());
...
<div align="center" style="color:#FF0000">
	...
	if($_REQUEST['msg']=='1')
	{
	echo "New Partner List added success!";
	}
	if($_REQUEST['msg']=='2')
	{
	echo "Partner List Deleted Success!";
	}
	?>      </div>        
<table width="94%" border="0" cellspacing="4" cellpadding="4" style="margin-left:30px;" >
  <tr  style="color:#FFF;" align="center">
    <td width="22%" bgcolor="#366092">Contact Person</td>
    <td width="20%" bgcolor="#366092">Partners Name</td>
    <td width="22%" bgcolor="#366092">Email</td>
    <td width="19%" bgcolor="#366092">Phone</td>
    <td width="17%" bgcolor="#366092">Select</td>
  </tr>
  <?php
  ...
  {?>
  <tr bgcolor="#dce6f2">
    <td><?php 	echo stripslashes($select_admin_row['partners_page']);?>               </td>
    <td><a href="view-partners-details.php?view_id=<?php echo $select_admin_row['id']?>" style="color:#000000;"><?php 	echo stripslashes($select_admin_row['partners_name']);?></a></td>
    <td><?php	//echo stripslashes($select_admin_row['email']);?>
	<a href="mailto:<?php	echo stripslashes($select_admin_row['email']);?>" style="color:#0000FF;"><?php	echo stripslashes($select_admin_row['email']);?></a></td>
    <td align="center"><?php echo stripslashes($select_admin_row['phone']);?>
</td>

    <td align="center"><strong style="text-decoration:underline; color:#FF0000"><a href="view-partners-details.php?view_id=<?php echo $select_admin_row['id']?>">Modify</a>
	      <?php
		  if($admin_user_type=='Super')
		  {?>
	 | <a href="delete-view-partners.php?view_id=<?php echo $select_admin_row['id']?>" onclick="return confirm_admin_delete();">Delete</a></strong>
	 <?php
	 }?>
	 </td>
  </tr>
