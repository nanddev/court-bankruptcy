...
?>
  ...
  <tr>
    <td colspan="2"><?php echo $citationInfo['FirstName'] . ' ' . $citationInfo['LastName'];?>  <br />
<?php echo $citationInfo['Address'];?> <br/>
<?php echo $citationInfo['City'];?>, <?php echo $citationInfo['State'];?> <?php echo $citationInfo['Zip'];?>
</td>
    <td colspan="2"></td>
    <td>&nbsp;</td>
  </tr>
