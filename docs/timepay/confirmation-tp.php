...
$timepayInfo = $_SESSION['timepayInfo2'];
...
<div style="width: 40%; float: left" ><a href="index.php"><img src="" width="165" height="123" border="0" style="vertical-align: middle;" /></a> </div>                
...
<div class="search" align="center"><table width="80%" border="0" cellspacing="4" cellpadding="4" style="border: 1px solid #999">
...
<?php
if (isset($timepayInfo['timepays'])) {
	foreach ($timepayInfo['timepays'] as $timepay) {
		echo '<tr>';
		echo "<td>${timepay['Contract_Num']}</td>";
		echo "<td>${timepay['ViolationDate']}</td>";
		echo "<td>${timepay['Jurisdiction']}</td>";
		echo "<td>${timepay['Charges']}</td>";
		echo "<td>$${timepay['FineAmount']}</td>";
		echo '</tr>';
	}
}
?>
  ...
  <tr>
    <td colspan="5"><?php echo $timepayInfo['FirstName'] . ' ' . $timepayInfo['LastName'];?>  <br />
<?php echo $timepayInfo['Address'];?> <br/>
<?php echo $timepayInfo['City'];?>, <?php echo $timepayInfo['State'];?> <?php echo $timepayInfo['Zip'];?>
</td>
  </tr>
</table>
</div>
...
<div align="center"><table width="80%" border="0" cellspacing="4" cellpadding="4" style="border: 1px solid #999">
  <tr>
    <td width="20%" colspan="3">Your payment: $<?php echo $timepayInfo['FineTotal'];?><br />
    Processing Fee: $<?php echo $timepayInfo['ProcessingTotal']; ?><br />
    <em><strong style="color:#FF0000">Total:</strong></em> $<?php echo $timepayInfo["Total"];?></td>
  ...
  <tr>
   ...
   <tr>
    <td>Zip</td>
    <td><?php echo $data['zipcode']; ?> 
</td>
  </tr>
   <tr>
    <td>Card Number</td>
    <td><?php echo $data['ccNum']; ?> 
</td>
  </tr>
   <tr>
    <td>Exp Date</td>
  ...
  <tr>
	...
	<?php
		if ($success) {
			echo "<h2><strong>Receipt Number: ".$receiptNumber."</strong>";
		}
	?>		
	</h2>
